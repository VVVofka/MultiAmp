...
void MLayBase::Create(const int_2 xy, const bool is_gpu){
	sz = xy;
	va.Create(sz, is_gpu);
	vf.Create(sz, is_gpu);
} // ////////////////////////////////////////////////////////////
void MLayBase::gpu2cpu(){
	va.gpu2cpu();
	vf.gpu2cpu();
} // ///////////////////////////////////////////////////////////////////////////////
void MLayBase::cpu2gpu(){
	va.cpu2gpu();
	vf.cpu2gpu();
} // ///////////////////////////////////////////////////////////////////////////////
bool MLayBase::isLoad() const{
...
std::string MLayBase::sDumpA(const int digits)const{
	char buf[4096];
...
std::string MLayBase::sDump(const MVGpuCpu<float_2>& v, const int digits)const{
	char buf[4096];
...
std::string MLayBase::sDumpF(const int digits)const{
