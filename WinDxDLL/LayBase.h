...
public:
	...
	void Create(const int_2 xy, const bool is_gpu, accelerator_view& m_accl_view);
	void Create(const int_2 xy, const std::vector<int>& va_inp, const bool is_gpu, accelerator_view& m_accl_view);
