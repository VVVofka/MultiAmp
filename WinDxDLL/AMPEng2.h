...
class AMPEng2{
	...
	std::unique_ptr<Concurrency::array<Vertex2D, 1>>	ar_screen; // for screen
	std::vector<std::unique_ptr<Concurrency::array<int, 2>>> vgpu_a;
	std::vector<std::unique_ptr<Concurrency::array<DrQuadro, 2>>> vgpu_f;
	std::unique_ptr<Concurrency::array<FLT2, 2>> ar_last_dirs;
